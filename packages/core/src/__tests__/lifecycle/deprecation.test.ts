...
describe('Lifecycle Deprecation', () => {
  const createMockDoc = (id: string, status?: any, successor?: string): OKFDocument => ({
    conceptId: id,
  ...
  it('should resolve the immediate successor if it is active', () => {
    ...
    const map = new Map([['doc-1', doc1], ['doc-2', doc2]]);
  ...
  it('should resolve a chain of successors', () => {
    ...
    const map = new Map([['doc-1', doc1], ['doc-2', doc2], ['doc-3', doc3]]);
