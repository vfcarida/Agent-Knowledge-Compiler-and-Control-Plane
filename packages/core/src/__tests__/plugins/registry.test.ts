...
describe('PluginRegistry', () => {
  it('discovers the example plugin', () => {
    ...
    const example = discovered.find(p => p.dirPath.includes('example-markdown-connector'));
  ...
  it('returns empty array for non-existent directory', () => {
    const discovered = PluginRegistry.discoverLocalPlugins('/non/existent/plugins/dir');
