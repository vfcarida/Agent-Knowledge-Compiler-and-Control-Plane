 ...
 */
export function normalizeLinkId(sourceConceptId: string, rawLink: string): string {
 ...
 */
export function extractMarkdownLinks(sourceConceptId: string, markdownBody: string): { targetConceptId: string, relationType: string }[] {
