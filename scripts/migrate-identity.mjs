...
const replacements = [
  {
    search: /Open Career Format Orchestrator/gi,
    replace: "Agent Knowledge Compiler and Control Plane (AKCP)",
  },
  {
    search: /Agent-ready Knowledge Reference Architecture/gi,
    replace: "Agent Knowledge Compiler and Control Plane (AKCP)",
  },
  {
    search: /Agent-ready-Knowledge-Reference-Architecture/gi,
    replace: "Agent-Knowledge-Compiler-and-Control-Plane",
  },
  {
    search: /ContextOps/g,
    replace: "Agent Knowledge Compiler and Control Plane (AKCP)",
