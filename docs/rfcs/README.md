...
The RFC (Request for Comments) process is the primary mechanism for proposing major changes to the ContextOps specifications, OKF Profiles, and MCP Tool Contracts.
...
- There is a clear paper trail of *why* a protocol decision was made.
