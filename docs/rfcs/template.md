...
## 1. Problem Statement
Describe the problem you are trying to solve. Why is this an issue for ContextOps users or autonomous agents? Focus on the *why* before the *how*.
...
Provide the exact CLI commands or manual steps required (e.g., `agent-ready migrate --to v2`).
