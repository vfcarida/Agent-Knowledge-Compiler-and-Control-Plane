...
- See [MCP Tool Contracts](../../docs/specs/mcp-tool-contracts.md) for more details.
- Want to apply this to HR, Compliance, or IT? Read about [Domain Adapters](../../docs/guides/create-domain-adapter.md).
